...
Class Partner_m extends CI_Model{
	...
	public function register($owner, $perusahaan, $bidang, $emailin, $address, $handphone, $password,$filename ){
...
//	}
   ...
   //email aktivin ketika diupload
    ...
    $this->email->from('partner@ayopeduli.com');
    //$list = array('user@gmail.com');
    $this->email->to($emailin,'gufron@ayopeduli.com');
...
public function record_count($partid) {
        //return $this->db->count_all('ap_product');
		//$this->db->get_where('ap_product', array('partnerid' => $partid));
		return $this->db->count_all('ap_product');
		//return $this->db->get_where('ap_product', array('partnerid' => $partid));
		
    }
 
    public function fetch_countries($partid, $limit, $start) {
...
public function insert_promo($filename){
   ...
   //email aktivin ketika diupload
	                                            ...
	                                            <td valign='top'>
	                                                ...
	                                                <table border='0' cellpadding='20' cellspacing='0' width='100%'>
	                                                    <tr>
	                                                        <td valign='top' class='bodyContent'>
	                                                            <div mc:edit='std_content00'>
	                                                                <h4 class='h4'>Hello Partner,</h4>
	                                                                Terima kasih telah membuat promo di ayopeduli.com, berikut ini adalah Informasi Promosi Anda :
	                                                            </div>
															</td>
	                                                    </tr>
	                                                    <tr>
	                                                      ...
	                                                      <td valign='top' class='bodyContent'>
	                                                            ...
	                                                            Untuk mengaktifkan promo anda, silahkan lakukan transfer donasi anda sejumlah $harga ke rekening berikut :<br />
                                                               <strong>Founder ayopeduli.com <br>
															   1. BCA a.n JAENUL KHUPRON acc. 739-078-7680 dengan mencantumkan partner id donasi anda dalam referensi transfer donasi.</strong><br /><br />
                                                               Note : <br />
                                                               1. Silahkan konfirmasi donasi melalui sms/whatsapp ke no 0812 1493 9954 <br />
															   	<strong>Partner ID # Nama perusahaan # Nama Promo</strong>                  
	                                                            </div>
															</td>
                                                    	</tr> 
	                                                </table>
    ...
    //$list = array('user@gmail.com');
    $this->email->to($emailpart,'gufron@ayopeduli.com');
    $this->email->subject('Promo Anda di ayopeduli.com');
    $this->email->message($email_body);
    $this->email->send();
	//end notif email	
		$datas = (array(
