...
<script src="/asset/js/additional-methods.min.js"></script>
	...
	<div class="row right buataksi all">
    	<h2 style="text-align:center;">Aksi yang perlu kamu bantu</h2>
        <div class="cat" id="portfolio-filter">           
                    <div class="category">
                        <div class="content-category">
                            <div class="image filters">
                                <a rel="kesehatan" ><img src="/asset/images/Kesehatan.png"></a>
                            </div>
                            <div class="title">
                                <h2>Kesehatan</h2>
                            </div>
                    ...
                    <div class="category">
                        <div class="content-category">
                            <div class="image filters">
                                <a class="but" data-filter="pendidikan"><img src="/asset/images/education.png"></a>
                            </div>
                            <div class="title">
                                <h2>Pendidikan</h2>
                            </div>
                    ...
                    <div class="category">
                        <div class="content-category">
                            <div class="image filters">
                                <a class="but" data-filter="lingkungan"><img src="/asset/images/lingkungan.png"></a>
                            </div>
                            <div class="title">
                                <h2>Lingkungan</h2>
                            </div>
