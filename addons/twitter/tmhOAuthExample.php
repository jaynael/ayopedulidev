  ...
  public function __construct($config = array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'consumer_key'    => '1R93UTFoZIRhlZzq9tSUlY0Iv',
        'consumer_secret' => 't5hLeOywy8oJb4OI8VwEQBt7JYHEvGkZQ3IMA2U7ABXPgGscvz',
        'token'           => $_SESSION['oauth']['res_oauth_token'],
        'secret'          => $_SESSION['oauth']['res_oauth_token_secret'],
        'bearer'          => substr(stristr($_SESSION['oauth']['res_oauth_token'],'-'),1),
